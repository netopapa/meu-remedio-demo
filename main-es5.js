...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AppComponent = /** @class */ (function () {
                ...
                AppComponent.prototype.ngOnInit = function () {
                    setTimeout(function () { _components_main_loading_main_loading_service__WEBPACK_IMPORTED_MODULE_2__["MainLoadingService"].show(); }, 1);
                };
                AppComponent.prototype.showOnMap = function (remedio) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var FarmacyListComponent = /** @class */ (function () {
                function FarmacyListComponent() {
                    this.farmacias = [];
                ...
                FarmacyListComponent.prototype.ngOnInit = function () {
                };
                FarmacyListComponent.prototype.hidePlaces = function () {
                    this.hideList.emit();
                };
                FarmacyListComponent.prototype.goToPharmacy = function (cmkr) {
                    this.showPharmacy.emit(cmkr);
                };
                return FarmacyListComponent;
            }());
            tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var GetLocationComponent = /** @class */ (function () {
                function GetLocationComponent() {
                }
                GetLocationComponent.prototype.ngOnInit = function () {
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MainLoadingComponent = /** @class */ (function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MainLoadingService = /** @class */ (function () {
                function MainLoadingService() {
                }
                MainLoadingService.show = function () {
                    this.isProgress.next(true);
                };
                MainLoadingService.hide = function () {
                    console.log("###################");
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MAPS_KEY = 'AIzaSyDKBB3HXOX-kJRBUxP9T8Kcq5d_tKA5zK0';
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DistanceRow = /** @class */ (function () {
                function DistanceRow() {
                    this.elements = [];
                }
                return DistanceRow;
            }());
            var DistanceElement = /** @class */ (function () {
                function DistanceElement() {
                }
                return DistanceElement;
            }());
            var DistanceInfo = /** @class */ (function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var FarmaciasService = /** @class */ (function (_super) {
                __extends(FarmaciasService, _super);
                function FarmaciasService(http) {
                    var _this = _super.call(this, http) || this;
                    _this.baseUrl = _environments__WEBPACK_IMPORTED_MODULE_3__["EVIRONMENTS"].MANAUS + 'Unidades.php';
                    return _this;
                }
                FarmaciasService.prototype.getAll = function () {
                    return this.get(this.baseUrl);
                };
                FarmaciasService.prototype.getFilter = function (query) {
                    return this.get(this.baseUrl + "?query=%" + query + "%");
                };
                return FarmaciasService;
            }(_rest_service__WEBPACK_IMPORTED_MODULE_4__["RestService"]));
            FarmaciasService.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MedicamentosService = /** @class */ (function (_super) {
                __extends(MedicamentosService, _super);
                function MedicamentosService(http) {
                    var _this = _super.call(this, http) || this;
                    _this.baseUrl = _environments__WEBPACK_IMPORTED_MODULE_4__["EVIRONMENTS"].MANAUS + 'Produtos.php';
                    return _this;
                }
                MedicamentosService.prototype.getAll = function () {
                    return this.get(this.baseUrl);
                };
                MedicamentosService.prototype.getFilter = function (query) {
                    return this.get(this.baseUrl + "?query=%" + query + "%");
                };
                return MedicamentosService;
            }(_rest_service__WEBPACK_IMPORTED_MODULE_2__["RestService"]));
            MedicamentosService.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var RestService = /** @class */ (function () {
                ...
                RestService.prototype.get = function (url, data) {
                ...
                RestService.prototype.put = function (url, data) {
                ...
                RestService.prototype.patch = function (url, data) {
                ...
                RestService.prototype.delete = function (url, data) {
                    var httpOptions = {
            ...
            var MapUtils = /** @class */ (function () {
                function MapUtils(dialog) {
                    ...
                    this.requestPosition = function () {
                        if (!_this.modalJaExibido) {
                            _this.locationDialog = _this.dialog.open(_components_get_location_get_location_component__WEBPACK_IMPORTED_MODULE_2__["GetLocationComponent"], {
                                width: '250px'
                            });
                            _this.locationDialog.afterClosed().subscribe(function () {
                    ...
                    this.geoSuccess = function (position) {
                        _this.costumerPosition = position;
                        _this.afterLoadPosition();
                    };
                    this.geoError = function (error) {
                        _this.requestPosition();
                        // switch (error.code) {
                ...
                MapUtils.prototype.ngOnInit = function () {
                    this.initMaps();
                };
                MapUtils.prototype.initMaps = function () {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var nativeMap;
                        var _this = this;
                        return __generator(this, function (_a) {
                            nativeMap = this.agmMap._mapsWrapper.getNativeMap();
                            nativeMap.then(function (map) {
                                _this.gmaps = map;
                                _this.distanceService = new google.maps.DistanceMatrixService();
                                _this.afterInitMaps();
                            });
                            return [2 /*return*/];
                        });
                ...
                MapUtils.prototype.buildMarker = function (position, icon) {
                    return new google.maps.Marker({
                        position: position,
                        icon: icon ? icon : 'assets/mapa/marker-farmacias.png'
                    });
                };
                MapUtils.prototype.removeAllFarmaciaMarkers = function () {
                    this.cmarkers.forEach(function (cmarker) {
                    ...
                    this.cmarkers = this.cmarkers.filter(function (cmarker) {
                        return cmarker.type === _providers_enums_marker_type_enum__WEBPACK_IMPORTED_MODULE_3__["MarkerType"].CUSTOMER;
                    });
                };
                MapUtils.prototype.moveToCenter = function () {
                    var _this = this;
                    if (this.costumerPosition) {
                        var coordinates = { lat: this.costumerPosition.coords.latitude, lng: this.costumerPosition.coords.longitude };
                        this.gmaps.panTo(coordinates);
                        setTimeout(function () { _this.smoothZoom(_this.zoom, _this.gmaps.getZoom()); }, 500);
                        window.scrollTo(0, document.body.scrollHeight);
                    }
                    else {
                        this.requestPosition();
                ...
                MapUtils.prototype.getDistance = function (origins, destinations) {
                    var _this = this;
                    this.distanceService.getDistanceMatrix({
                        ...
                        if (status === _providers_model_distance_matrix_model__WEBPACK_IMPORTED_MODULE_4__["DistanceStatus"].OK) {
                            _this.costumerDistance = res;
                            _this.afterLoadDistance();
                        }
                        else {
                ...
                MapUtils.prototype.smoothZoom = function (max, cnt) {
                    var _this = this;
                    if (cnt >= max) {
                        this.zoom = max;
                        return;
                        ...
                        var z_1 = google.maps.event.addListener(this.gmaps, 'zoom_changed', function () {
                            google.maps.event.removeListener(z_1);
                            _this.smoothZoom(max, cnt + 1);
                        });
                        setTimeout(function () { _this.gmaps.setZoom(cnt); }, 80);
                    }
                };
                MapUtils.prototype.afterLoadPosition = function () { };
                MapUtils.prototype.afterLoadDistance = function () { };
                MapUtils.prototype.afterInitMaps = function () { };
                return MapUtils;
            }());
            tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HomeComponent = /** @class */ (function () {
                ...
                HomeComponent.prototype.ngOnInit = function () {
                    ...
                    this.textQuery.valueChanges.subscribe(function (query) {
                        _this.filteredRemedios = _this.remedios.filter(function (rem) {
                            return rem.descricao.toLowerCase().includes(query.toLowerCase());
                        });
                    });
                };
                HomeComponent.prototype.remedioSelected = function () {
                    var _this = this;
                    this.medicamento = this.remedios.find(function (rem) { return rem.descricao.toLowerCase() === _this.textQuery.value.toLowerCase(); });
                    this.onRemedioSelected.emit(this.medicamento);
                };
                HomeComponent.prototype.getMedicamentos = function () {
                    var _this = this;
                    this.service.getAll().subscribe(function (success) {
                        _this.remedios = success;
                        _this.filteredRemedios = success;
                    });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UnidadesComponent = /** @class */ (function (_super) {
                ...
                function UnidadesComponent(service, dialog) {
                    var _this = _super.call(this, dialog) || this;
                    _this.service = service;
                    _this.farmacias = [];
                    _this.nearFarmacias = [];
                    _this.farmaciasComMedicamento = [];
                    _this.showPharmList = false;
                    return _this;
                }
                UnidadesComponent.prototype.ngOnInit = function () {
                    _super.prototype.ngOnInit.call(this);
                };
                UnidadesComponent.prototype.afterInitMaps = function () {
                    this.getFarmacias();
                };
                UnidadesComponent.prototype.getFarmacias = function () {
                    var _this = this;
                    this.service.getAll().subscribe(function (success) {
                        _this.farmacias = success;
                        _this.buildFarmaciaMarkers(_this.farmacias);
                        setTimeout(function () { src_app_components_main_loading_main_loading_service__WEBPACK_IMPORTED_MODULE_3__["MainLoadingService"].hide(); }, 1000);
                    }, function () {
                        setTimeout(function () { src_app_components_main_loading_main_loading_service__WEBPACK_IMPORTED_MODULE_3__["MainLoadingService"].hide(); }, 1000);
                    });
                };
                UnidadesComponent.prototype.buildFarmaciaMarkers = function (farmacias) {
                    for (var i = 0; i < farmacias.length; i++) {
                        var coordinates = { lat: parseFloat(farmacias[i].latitude), lng: parseFloat(farmacias[i].longitude) };
                        var marker = this.buildMarker(coordinates);
                        var cmarker = new src_app_providers_model_custom_marker_dto__WEBPACK_IMPORTED_MODULE_5__["CustomMarker"]();
                ...
                UnidadesComponent.prototype.createCustomerMarker = function (coordinates) {
                    var marker = this.buildMarker(coordinates, 'assets/mapa/marker-person.png');
                    var cmarker = new src_app_providers_model_custom_marker_dto__WEBPACK_IMPORTED_MODULE_5__["CustomMarker"]();
                ...
                UnidadesComponent.prototype.setRemedio = function (remedio) {
                ...
                UnidadesComponent.prototype.afterLoadPosition = function () {
                    var _this = this;
                    var coordinates = { lat: this.costumerPosition.coords.latitude, lng: this.costumerPosition.coords.longitude };
                ...
                UnidadesComponent.prototype.gotoPharmacy = function (cmkr) {
                    var _this = this;
                    this.togglePharmList();
                    var coordinates = { lat: parseFloat(cmkr.farmacia.latitude), lng: parseFloat(cmkr.farmacia.longitude) };
                    setTimeout(function () { _this.gmaps.panTo(coordinates); }, 500);
                };
                UnidadesComponent.prototype.showOnlyNearFarmacias = function () {
                    // TODO: filtrar por farmácias que possuem o Medicamento pesquisado
                    this.farmaciasComMedicamento = this.farmacias.slice(60, 80);
                    var destinations = this.farmaciasComMedicamento.map(function (farm) { return { lat: parseFloat(farm.latitude), lng: parseFloat(farm.longitude) }; });
                    var origins = [{ lat: this.costumerPosition.coords.latitude, lng: this.costumerPosition.coords.longitude }];
                    this.getDistance(origins, destinations);
                };
                UnidadesComponent.prototype.afterLoadDistance = function () {
                ...
                UnidadesComponent.prototype.createCustomMarkersFrom = function (farmacias) {
                    for (var i = 0; i < farmacias.length; i++) {
                        var coordinates = { lat: parseFloat(farmacias[i].latitude), lng: parseFloat(farmacias[i].longitude) };
                        var marker = this.buildMarker(coordinates);
                        var cmarker = new src_app_providers_model_custom_marker_dto__WEBPACK_IMPORTED_MODULE_5__["CustomMarker"]();
                ...
                UnidadesComponent.prototype.removeMarkersOutOfRadius = function (raio) {
                    var cmarkersAux = [];
                    this.cmarkers.forEach(function (cmkr) {
                    ...
                    cmarkersAux.push(this.cmarkers.find(function (cmk) { return cmk.type === src_app_providers_enums_marker_type_enum__WEBPACK_IMPORTED_MODULE_4__["MarkerType"].CUSTOMER; }));
                    this.cmarkers = [];
                    this.cmarkers = cmarkersAux;
                };
                UnidadesComponent.prototype.scrollToTop = function () {
                    window.scrollTo(0, 0);
                };
                UnidadesComponent.prototype.togglePharmList = function () {
                    this.showPharmList = !this.showPharmList;
                };
                return UnidadesComponent;
            }(src_app_utils_map_utils__WEBPACK_IMPORTED_MODULE_8__["MapUtils"]));
            UnidadesComponent.ctorParameters = function () { return [
